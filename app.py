...
app.config['MYSQL_USER'] = 'RtbT7ToAab'
app.config['MYSQL_PASSWORD'] = "Va9b75LQOp"
app.config['MYSQL_DB'] = 'RtbT7ToAab'
...
def register():
    ...
    if request.method == "POST":
        ...
        if(user):
            ...
            cursor.execute("INSERT INTO users VALUES(% s,% s,% s,% s,% s,% s)",(name,fname,username,email,password,cpassword,mobile,))
